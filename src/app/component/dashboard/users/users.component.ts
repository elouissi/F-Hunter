          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
              ...
              <div class="ps-3">
                ...
                <div class="font-normal text-gray-500">neil.sims.com</div>
              </div>
            </th>
            <td class="px-6 py-4">
              React Developer
          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              ...
              <div class="ps-3">
                ...
                <div class="font-normal text-gray-500">bonnie.com</div>
              </div>
            </th>
            <td class="px-6 py-4">
              Designer
          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              ...
              <div class="ps-3">
                ...
                <div class="font-normal text-gray-500">jese.com</div>
              </div>
            </th>
            <td class="px-6 py-4">
              Vue JS Developer
          ...
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <th scope="row" class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              ...
              <div class="ps-3">
                ...
                <div class="font-normal text-gray-500">thomes.com</div>
              </div>
            </th>
            <td class="px-6 py-4">
              UI/UX Engineer
